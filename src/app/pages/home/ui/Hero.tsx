    ...
    return (
        <section className="relative overflow-hidden">
            ...
            <div className="pointer-events-none absolute inset-0 -z-10">
                ...
                {/* Soft grid pattern */}
                <svg className="absolute inset-0 h-full w-full opacity-30 [mask-image:radial-gradient(ellipse_at_center,white,transparent_70%)]" aria-hidden viewBox="0 0 100 100" preserveAspectRatio="none">
                    <defs>
                ...
                {/* Glow */}
                <div className="absolute -top-24 left-1/2 h-64 w-[36rem] -translate-x-1/2 rounded-full bg-emerald-200/40 blur-3xl" />
            </div>
            ...
            >
                ...
                <div className="md:col-span-7 lg:col-span-7">
                    <motion.p variants={fadeUp} className="mb-3 inline-block rounded-full border px-3 py-1 text-xs font-medium tracking-wide text-emerald-700">
                    ...
                    >
                        Jurnal Andijon qishloq xo‘jaligi va agrotexnologiyalar instituti muassisi bo‘lgan milliy ilmiy nashr bo‘lib,
                        dolzarb ilmiy ishlanmalar, tahlillar va tavsiyalarni e’lon qiladi.
                    </motion.p>
                ...
                >
                    <div className="relative mx-auto w-full max-w-md space-y-4">
                        {/* Illustration */}
                        <div className="relative aspect-[4/3] overflow-hidden rounded-3xl border border-emerald-100 bg-gradient-to-br from-emerald-50 to-white p-6 shadow-sm">
                            <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_30%_20%,rgba(16,185,129,0.15),transparent_35%),radial-gradient(circle_at_80%_50%,rgba(16,185,129,0.1),transparent_35%)]" />
                            <h3 className="text-lg font-semibold text-emerald-900">Ilm-fan va taʼlim</h3>
                            <p className="mt-2 text-sm leading-relaxed text-emerald-900/80">
                                Qishloq xo‘jaligi va agrotexnologiyalar bo‘yicha innovatsion tadqiqotlar, tahlillar va tavsiyalar.
                            </p>
                        </div>
                        ...
                        <div className="grid gap-3 sm:grid-cols-2">
                            <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                                ...
                                <p className="text-base font-semibold text-gray-900">Andijon qishloq xo‘jaligi va agrotexnologiyalar instituti</p>
                            </div>
                            <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                            ...
                            <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                                ...
                                <p className="text-base font-semibold text-gray-900">OAK Rayosatining Qarori 29.12.2023 й №347/5</p>
                            </div>
